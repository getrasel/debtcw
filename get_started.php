              ...
              <div class="ftco-footer-widget mb-4">
                ...
                <div class="d-md-flex">
                  <ul class="list-unstyled w-100">
                    ...
                    <li><a href="#"><span class="ion ion-ios-arrow-round-forward me-2"></span>About</a></li>
                    <li><a href="#"><span class="ion ion-ios-arrow-round-forward me-2"></span>Place a Claim</a></li>
                    <li><a href="#"><span class="ion ion-ios-arrow-round-forward me-2"></span>FAQs</a></li>
                  </ul>
                  <ul class="list-unstyled w-100">
                    <li><a href="#"><span class="ion ion-ios-arrow-round-forward me-2"></span>Consumer Help</a></li>
                    <li><a href="#"><span class="ion ion-ios-arrow-round-forward me-2"></span>Login Client</a></li>
                    <li><a href="#"><span class="ion ion-ios-arrow-round-forward me-2"></span>Pricing</a></li>
                    <li><a href="#"><span class="ion ion-ios-arrow-round-forward me-2"></span>Contact</a></li>
                  </ul>
                </div>
              </div>
            </div>
              ...
              <div class="ftco-footer-widget mb-4">
                ...
                <div class="block-21 mb-4 d-flex">
                  ...
                  <div class="text">
                    ...
                    <h3 class="heading"><a href="blog-single.html">Debt recovery is a big challenge for business</a></h3>
                  </div>
                </div>
                <div class="block-21 mb-4 d-flex">
                  ...
                  <div class="text">
                    ...
                    <h3 class="heading"><a href="#">Ready for Regulation F with successful collections</a></h3>
                  </div>
                </div>
              </div>
            </div>
